...
add_zombie_weapon( weapon_name, hint, cost, weaponVO, variation_count, ammo_cost  )
{
	...
	struct.hint = "Press &&1 to buy "+hint+" [Cost: "+cost+"]";
	struct.cost = cost;
...
{/**
	...
	*/
	// FS Mod guns below
	add_zombie_weapon( "fs_colt", 									"1911", 					50,		"vox_crappy",	8 );
	add_zombie_weapon( "fs_m4", 									"M4", 				1200,	"vox_ppsh",		5 );
	add_zombie_weapon( "fs_aug", 									"AUG HBAR", 				1200,	"vox_ppsh",		5 );
	add_zombie_weapon( "fs_aug_scope", 									"AUG HBAR Scoped", 				1750,	"vox_ppsh",		5 );
