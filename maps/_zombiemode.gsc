...
round_start()
{
	level waittill("gm_has_been_chosen",round_number_gm);
	if(round_number_gm < 2){
		...
		for(i=1;i<=round_number_gm;i++){
			level.round_number++;
			ai_calculate_health();
		}
		level.round_number = round_number_gm; 
